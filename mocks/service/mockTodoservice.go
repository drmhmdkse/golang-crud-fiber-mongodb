...
// Source: mangoDb/services (interfaces: TodoService)

// Package services is a generated GoMock package.
package services

import (
	models "mangoDb/models"
	reflect "reflect"
...
func (m *MockTodoService) TodoInsert(arg0 models.Todo) (bool, error) {
	m.ctrl.T.Helper()
...
// TodoUpdate mocks base method.
func (m *MockTodoService) TodoUpdate(arg0 primitive.ObjectID, arg1 models.Todo) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TodoUpdate", arg0, arg1)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TodoUpdate indicates an expected call of TodoUpdate.
func (mr *MockTodoServiceMockRecorder) TodoUpdate(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TodoUpdate", reflect.TypeOf((*MockTodoService)(nil).TodoUpdate), arg0, arg1)
}
